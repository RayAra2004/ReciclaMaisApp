...
public class DescricaoPontoViewModel extends AndroidViewModel {
    ...
    public LiveData<Boolean> postComentario(String comentario, int nota, String idPontoColeta) {
        ...
        executorService.execute(new Runnable() {
            ...
            public void run() {
                ...
                // em caso contrário
                boolean b = pontoColetaRepository.postComentario(comentario, nota, idPontoColeta);
